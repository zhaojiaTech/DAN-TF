...
void InitDefaultsTFProfTensorProtoImpl() {
...
void InitDefaultsTFProfTensorProto() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsTFProfTensorProtoImpl);
}

void InitDefaultsGraphNodeProto_InputShapesEntry_DoNotUseImpl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
void InitDefaultsGraphNodeProto_InputShapesEntry_DoNotUse() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsGraphNodeProto_InputShapesEntry_DoNotUseImpl);
}

void InitDefaultsGraphNodeProtoImpl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_tensorflow_2fcore_2fprofiler_2ftfprof_5foutput_2eproto::InitDefaultsTFProfTensorProto();
  protobuf_tensorflow_2fcore_2fframework_2ftensor_5fshape_2eproto::InitDefaultsTensorShapeProto();
  protobuf_tensorflow_2fcore_2fprofiler_2ftfprof_5foutput_2eproto::InitDefaultsGraphNodeProto_InputShapesEntry_DoNotUse();
  {
...
void InitDefaultsGraphNodeProto() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsGraphNodeProtoImpl);
}

void InitDefaultsMultiGraphNodeProtoImpl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_tensorflow_2fcore_2fprofiler_2ftfprof_5foutput_2eproto::InitDefaultsGraphNodeProto();
  {
...
void InitDefaultsMultiGraphNodeProto() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsMultiGraphNodeProtoImpl);
}

void InitDefaultsAdviceProto_CheckersEntry_DoNotUseImpl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_tensorflow_2fcore_2fprofiler_2ftfprof_5foutput_2eproto::InitDefaultsAdviceProto_Checker();
  {
...
void InitDefaultsAdviceProto_CheckersEntry_DoNotUse() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsAdviceProto_CheckersEntry_DoNotUseImpl);
}

void InitDefaultsAdviceProto_CheckerImpl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
void InitDefaultsAdviceProto_Checker() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsAdviceProto_CheckerImpl);
}

void InitDefaultsAdviceProtoImpl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_tensorflow_2fcore_2fprofiler_2ftfprof_5foutput_2eproto::InitDefaultsAdviceProto_CheckersEntry_DoNotUse();
  {
...
void InitDefaultsAdviceProto() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsAdviceProtoImpl);
}
...
void GraphNodeProto::SerializeWithCachedSizes(
  ...
  if (!this->input_shapes().empty()) {
    ...
    if (output->IsSerializationDeterministic() &&
      ...
      ::google::protobuf::scoped_ptr<GraphNodeProto_InputShapesEntry_DoNotUse> entry;
...
::google::protobuf::uint8* GraphNodeProto::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->has_tensor_value()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        15, *tensor_value_, deterministic, target);
  }
...
MultiGraphNodeProto::MultiGraphNodeProto()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_tensorflow_2fcore_2fprofiler_2ftfprof_5foutput_2eproto::InitDefaultsMultiGraphNodeProto();
  }
  SharedCtor();
...
AdviceProto::AdviceProto()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_tensorflow_2fcore_2fprofiler_2ftfprof_5foutput_2eproto::InitDefaultsAdviceProto();
  }
  SharedCtor();
...
void AdviceProto::SerializeWithCachedSizes(
  ...
  if (!this->checkers().empty()) {
    ...
    if (output->IsSerializationDeterministic() &&
      ...
      ::std::sort(&items[0], &items[static_cast<ptrdiff_t>(n)], Less());
      ::google::protobuf::scoped_ptr<AdviceProto_CheckersEntry_DoNotUse> entry;
      for (size_type i = 0; i < n; i++) {
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::tfprof::TFProfTensorProto* Arena::Create< ::tensorflow::tfprof::TFProfTensorProto >(Arena* arena) {
  return Arena::CreateInternal< ::tensorflow::tfprof::TFProfTensorProto >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::tfprof::GraphNodeProto_InputShapesEntry_DoNotUse* Arena::Create< ::tensorflow::tfprof::GraphNodeProto_InputShapesEntry_DoNotUse >(Arena* arena) {
  return Arena::CreateInternal< ::tensorflow::tfprof::GraphNodeProto_InputShapesEntry_DoNotUse >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::tfprof::GraphNodeProto* Arena::Create< ::tensorflow::tfprof::GraphNodeProto >(Arena* arena) {
  return Arena::CreateInternal< ::tensorflow::tfprof::GraphNodeProto >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::tfprof::MultiGraphNodeProto* Arena::Create< ::tensorflow::tfprof::MultiGraphNodeProto >(Arena* arena) {
  return Arena::CreateInternal< ::tensorflow::tfprof::MultiGraphNodeProto >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::tfprof::AdviceProto_CheckersEntry_DoNotUse* Arena::Create< ::tensorflow::tfprof::AdviceProto_CheckersEntry_DoNotUse >(Arena* arena) {
  return Arena::CreateInternal< ::tensorflow::tfprof::AdviceProto_CheckersEntry_DoNotUse >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::tfprof::AdviceProto_Checker* Arena::Create< ::tensorflow::tfprof::AdviceProto_Checker >(Arena* arena) {
  return Arena::CreateInternal< ::tensorflow::tfprof::AdviceProto_Checker >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::tfprof::AdviceProto* Arena::Create< ::tensorflow::tfprof::AdviceProto >(Arena* arena) {
