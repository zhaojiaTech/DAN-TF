...
void InitDefaultsOptionsProtoImpl() {
...
void InitDefaultsOptionsProto() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsOptionsProtoImpl);
}

void InitDefaultsAdvisorOptionsProto_CheckersEntry_DoNotUseImpl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_tensorflow_2fcore_2fprofiler_2ftfprof_5foptions_2eproto::InitDefaultsAdvisorOptionsProto_CheckerOption();
  {
...
void InitDefaultsAdvisorOptionsProto_CheckersEntry_DoNotUse() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsAdvisorOptionsProto_CheckersEntry_DoNotUseImpl);
}

void InitDefaultsAdvisorOptionsProto_CheckerOption_OptionsEntry_DoNotUseImpl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
void InitDefaultsAdvisorOptionsProto_CheckerOption_OptionsEntry_DoNotUse() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsAdvisorOptionsProto_CheckerOption_OptionsEntry_DoNotUseImpl);
}

void InitDefaultsAdvisorOptionsProto_CheckerOptionImpl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_tensorflow_2fcore_2fprofiler_2ftfprof_5foptions_2eproto::InitDefaultsAdvisorOptionsProto_CheckerOption_OptionsEntry_DoNotUse();
  {
...
void InitDefaultsAdvisorOptionsProto_CheckerOption() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsAdvisorOptionsProto_CheckerOptionImpl);
}

void InitDefaultsAdvisorOptionsProtoImpl() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_tensorflow_2fcore_2fprofiler_2ftfprof_5foptions_2eproto::InitDefaultsAdvisorOptionsProto_CheckersEntry_DoNotUse();
  {
...
void InitDefaultsAdvisorOptionsProto() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsAdvisorOptionsProtoImpl);
}
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "tensorflow/core/profiler/tfprof_options.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
OptionsProto::OptionsProto()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_tensorflow_2fcore_2fprofiler_2ftfprof_5foptions_2eproto::InitDefaultsOptionsProto();
  }
  SharedCtor();
...
void AdvisorOptionsProto_CheckerOption::SerializeWithCachedSizes(
  ...
  if (!this->options().empty()) {
    ...
    if (output->IsSerializationDeterministic() &&
      ...
      ::google::protobuf::scoped_ptr<AdvisorOptionsProto_CheckerOption_OptionsEntry_DoNotUse> entry;
...
AdvisorOptionsProto::AdvisorOptionsProto()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_tensorflow_2fcore_2fprofiler_2ftfprof_5foptions_2eproto::InitDefaultsAdvisorOptionsProto();
  }
  SharedCtor();
...
void AdvisorOptionsProto::SerializeWithCachedSizes(
  ...
  if (!this->checkers().empty()) {
    ...
    if (output->IsSerializationDeterministic() &&
      ...
      ::std::sort(&items[0], &items[static_cast<ptrdiff_t>(n)], Less());
      ::google::protobuf::scoped_ptr<AdvisorOptionsProto_CheckersEntry_DoNotUse> entry;
      for (size_type i = 0; i < n; i++) {
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::tfprof::OptionsProto* Arena::Create< ::tensorflow::tfprof::OptionsProto >(Arena* arena) {
  return Arena::CreateInternal< ::tensorflow::tfprof::OptionsProto >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::tfprof::AdvisorOptionsProto_CheckersEntry_DoNotUse* Arena::Create< ::tensorflow::tfprof::AdvisorOptionsProto_CheckersEntry_DoNotUse >(Arena* arena) {
  return Arena::CreateInternal< ::tensorflow::tfprof::AdvisorOptionsProto_CheckersEntry_DoNotUse >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::tfprof::AdvisorOptionsProto_CheckerOption_OptionsEntry_DoNotUse* Arena::Create< ::tensorflow::tfprof::AdvisorOptionsProto_CheckerOption_OptionsEntry_DoNotUse >(Arena* arena) {
  return Arena::CreateInternal< ::tensorflow::tfprof::AdvisorOptionsProto_CheckerOption_OptionsEntry_DoNotUse >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::tfprof::AdvisorOptionsProto_CheckerOption* Arena::Create< ::tensorflow::tfprof::AdvisorOptionsProto_CheckerOption >(Arena* arena) {
  return Arena::CreateInternal< ::tensorflow::tfprof::AdvisorOptionsProto_CheckerOption >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::tfprof::AdvisorOptionsProto* Arena::Create< ::tensorflow::tfprof::AdvisorOptionsProto >(Arena* arena) {
