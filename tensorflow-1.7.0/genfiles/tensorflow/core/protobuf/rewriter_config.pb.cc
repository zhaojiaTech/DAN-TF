...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      ...
      "mizer_target_node_name_scope\030\006 \001(\t\0226\n\rau"
      ...
      "SIVE\020\003\"\237\001\n\nMemOptType\022\023\n\017DEFAULT_MEM_OPT"
      "\020\000\022\016\n\nNO_MEM_OPT\020\001\022\n\n\006MANUAL\020\002\022\027\n\023SWAPPI"
      "NG_HEURISTICS\020\004\022\034\n\030RECOMPUTATION_HEURIST"
      "ICS\020\005\022\031\n\025SCHEDULING_HEURISTICS\020\006\022\016\n\nHEUR"
      "ISTICS\020\003B5\n\030org.tensorflow.frameworkB\024Re"
      "writerConfigProtosP\001\370\001\001b\006proto3"
  };
...
RewriterConfig::RewriterConfig(const RewriterConfig& from)
  ...
  ::memcpy(&layout_optimizer_, &from.layout_optimizer_,
    static_cast<size_t>(reinterpret_cast<char*>(&function_optimization_) -
    reinterpret_cast<char*>(&layout_optimizer_)) + sizeof(function_optimization_));
...
void RewriterConfig::SharedCtor() {
  ...
  ::memset(&auto_parallel_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&function_optimization_) -
      reinterpret_cast<char*>(&auto_parallel_)) + sizeof(function_optimization_));
  _cached_size_ = 0;
}
